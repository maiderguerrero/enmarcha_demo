...
(function (blink) {
	...
	var enmarcha_demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	enmarcha_demoStyle.prototype = {
		bodyClassName: 'content_type_clase_enmarcha_demo',
		ckEditorStyles: {
			name: 'enmarcha_demo',
			styles: [
		...
		formatCarouselindicators: function () {
			...
			$navbarBottom
				.attr('class', 'enmarcha_demo-navbar')
		...
		animateNavbarOnScroll: function () {
			...
			var $navbar = $('.enmarcha_demo-navbar');
			var lastScrollTop = 0;
        ...
        changeHighBar: function () {
            if($('.enmarcha_demo-navbar').length>0 && $('.navbar').length>0){
                blink.theme.setTopByHeight('.navbar', '.enmarcha_demo-navbar');
            }
        }
	};

	enmarcha_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), enmarcha_demoStyle.prototype);

	blink.theme.styles['enmarcha_demo'] = enmarcha_demoStyle;
